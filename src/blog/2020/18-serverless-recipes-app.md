...
<img src="/static/img/blog/client-serverless-credit-faunadb.png" class="img-fluid img-center auto-invert" alt="client-serverless application model">
...
After some hours of less successful trial and error cycles, I stumbled upon this article recommending the `netlify-cli` module: {% reply "Solve CORS once and for all with Netlify Dev", "https://alligator.io/nodejs/solve-cors-once-and-for-all-netlify-dev" %}
...
<img src="/static/img/blog/fauna-dashboard.png" class="img-fluid img-center auto-invert" alt="FaunaDB dashboard">
