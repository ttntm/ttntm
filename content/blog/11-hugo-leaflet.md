...
tags:
    ...
    - leaflet
    - openstreetmap
tw-image: https://ttntm.github.io/img/blog/map.jpg
---
...
It should all be rather self-explanatory - name, address, postcode/city and country are based on data you'll either have or easily find. The latitude/longitude can be a bit tricky to obtain, but I found {{< link-underline-ext "this article" "www.businessinsider.de/international/how-to-find-coordinates-on-google-maps/" >}} helpful in case you're looking for something similar.
...
If you're not familiar with the way Hugo handles (JSON) data files, best head over there for a moment: {{< link-underline-ext "Hugo Docs - Data Templates" "gohugo.io/templates/data-templates/" >}}
...
- Leaflet 1.2.0
- Leaflet.markercluster 1.4.1: {{< link-underline-ext "GitHub" "github.com/Leaflet/Leaflet.markercluster">}}
- leaflet-locatecontrol 0.70: {{< link-underline-ext "GitHub" "github.com/domoritz/leaflet-locatecontrol">}}
...
All necessary information regarding Hugo installation can be found here: {{< link-underline-ext "Hugo Docs - Install Hugo" "gohugo.io/getting-started/installing/" >}}
